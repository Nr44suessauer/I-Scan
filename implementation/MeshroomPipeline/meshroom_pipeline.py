...
IMAGE_DIR = MR_PIPELINE_DIR + r"\images\cameraInit.sfm"
PIPELINE_DIR = MR_PIPELINE_DIR + "\\pipelines\\" # Templates can be found here: ...\Meshroom-2025.1.0\aliceVision\share\meshroom
